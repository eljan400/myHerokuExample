...
var playlist = Vue.component('playlist', {
  ...
  template: `
    ...
    <div>
      ...
      <div id="add-song" class="mt-5 p-2 rounded border">

       <div class="form-group">

         <label for="song-title">Song Title</label>

         <input v-model="newSong.title" type="text" class="form-control" id="song-title"aria-describedby="email Help" placeholder="Enter song Title">
       ...
       <button @click="addSong" type="submit" class="btn btn-primary">Submit</button>
